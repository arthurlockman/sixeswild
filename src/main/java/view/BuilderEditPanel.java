...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$()
    {
        ...
        tiles = new ButtonGroup();
        tiles.add(activeRadioButton);
        tiles.add(activeRadioButton);
        tiles.add(sixRadioButton);
        tiles.add(bucketRadioButton);
        tiles.add(inactiveRadioButton);
    }
